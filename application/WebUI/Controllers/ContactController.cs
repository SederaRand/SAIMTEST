    ...
    public class ContactController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            foreach (var contact in listContact)
            {
                ...
                contactModel.Status = (contact.Status == true) ? contactModel.Status = "Favori" : contactModel.Status = "Non Favori";
        ...
        public IActionResult Create(ContactModel modelView)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (modelView.Status.ToString() == "false") contact.Status = false;
